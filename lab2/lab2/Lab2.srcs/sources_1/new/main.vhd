...
D4: w2 port map (in1=>ACLR_S, in2=>ALOAD_S,  in3=> A_IN, in4=>ALOAD_S, in5=>ACLR_NOT_IN,c1=> CLK_NOT_S, d1=>TMP_OUTS_S(4), 
out1=> DFF_OUTS_S(4), inversive_out=> DFF_NOT_OUTS_S(4));

D3: w2 port map (in1=>ACLR_S, in2=>ALOAD_S,  in3=>B_IN , in4=>ALOAD_S, in5=>ACLR_NOT_IN,c1=> CLK_NOT_S, d1=>TMP_OUTS_S(3), 
out1=> DFF_OUTS_S(3), inversive_out=> DFF_NOT_OUTS_S(3)); 

D2: w2 port map (in1=>ACLR_S, in2=>ALOAD_S,  in3=>C_IN , in4=>ALOAD_S, in5=>ACLR_NOT_IN,c1=> CLK_NOT_S, d1=>TMP_OUTS_S(2), 
out1=> DFF_OUTS_S(2), inversive_out=> DFF_NOT_OUTS_S(2)); 

D1: w2 port map (in1=>ACLR_S, in2=>ALOAD_S,  in3=>D_IN , in4=>ALOAD_S, in5=>ACLR_NOT_IN,c1=> CLK_NOT_S, d1=>TMP_OUTS_S(1), 
